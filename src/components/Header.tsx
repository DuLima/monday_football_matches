...
export function Header({ active, onChange }: Props) {
  return (
    <header className="sticky top-0 z-30 bg-gradient-to-b from-[#073615] to-[#0b4d1f] shadow-md">
          ...
          {TABS.map(tab => {
            ...
            return (
              <button
                ...
                className={
                  'group relative flex items-center gap-2 whitespace-nowrap rounded-t-md px-4 py-3 text-sm font-semibold transition ' +
                  (isActive
